  ...
  return (
    <div className="py-10 bg-white dark:bg-dark">
      <div className="container">
        <div className="border-stroke dark:border-dark-3 mb-11 flex items-center rounded-md border border-l-8 border-l-[#00B078] bg-white dark:bg-dark-2 p-5 pl-8">
          <div className="mr-5 flex h-9 w-full max-w-9 items-center justify-center rounded-full bg-[#00B078]">
            <svg
              width={20}
              height={20}
              viewBox="0 0 20 20"
